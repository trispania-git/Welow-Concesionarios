...
?>
<form class="welow-buscador" method="get" action="<?php echo esc_url( $accion ); ?>">
    ...
    <div class="welow-buscador__campos">
        ...
        <?php if ( in_array( 'tipo_venta', $campos ) ) : ?>
            <label>
                <span>Tipo</span>
                <select name="welow_tipo_venta">
                    <option value="">Todos</option>
                    <?php foreach ( $tipos_venta as $key => $label ) : ?>
                        <option value="<?php echo esc_attr( $key ); ?>" <?php selected( $v( 'tipo_venta' ), $key ); ?>>
